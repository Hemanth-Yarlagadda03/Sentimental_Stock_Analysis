...
#    output_dir = 'C:/Users/kowshik/Study/Projects/sentiment/myproject/pro/flask_app/visualizations/'
#    
...
def process_sentiment(file_path):
    ...
    for file_name, html_table in html_tables.items():
        ...
        for company in mean_scores.columns.levels[1]:
            ...
            # Save the plot
            plot_file_name = f"{company}_{datetime.now().strftime('%d%b')}.png"  # Adjust filename as needed
